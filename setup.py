...
setuptools.setup(
    ...
    description="Approachable neural net implementation in pure numpy","Backward Propogation","Loss Functions","Numpy",
                 "Feed Forward Networks","Neural Networks","Gradient Descent","Visualization of Neural Networks","Neural Net",
